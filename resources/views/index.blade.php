    ...
    <section class="kg-home-hero">
      <div class="kg-home-hero__inner">
        <div class="kg-home-hero__logos">
          <a href="/"><img src="img/logokabul.png" alt="Kabul logo" class="logo-icon"></a>
          <a href="/"><img src="img/Desain_tanpa.png" alt="Kabul Art Gallery" class="logo-text"></a>
        </div>
      </div>
    </section>
      ...
      <div class="kg-info-list">
        ...
        <article class="kg-info-card">
          <div class="kg-info-card__img">
            <img src="{{ asset('/storage/postsimg/'.$post->image) }}" alt="informasi">
          </div>
      ...
      <div class="kg-artwork-grid">
        ...
        <article class="kg-artwork-card">
          <div class="kg-artwork-card__img-wrap">
            <img src="{{ asset('/storage/postsimg/'.$post->image) }}" alt="{{ $post->nama }}">
          </div>
